...
class AuthScreen(Screen):
    def compose(self) -> ComposeResult:
        ...
        yield Vertical(
            ...
            Label("", classes="instruction"),
            Input(placeholder="MoodleSession (cópialo de DevTools \u2192 Cookies)", id="moodle-session", password=True),
            Input(placeholder="sesskey (cópialo de la URL ?sesskey=XXXXX)", id="sesskey", password=True),
